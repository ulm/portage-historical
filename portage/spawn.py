...
# License: GPL2
# $Header: /local/data/ulm/cvs/history/var/cvsroot/gentoo-src/portage/portage/spawn.py,v 1.2 2005/07/20 14:33:12 ferringb Exp $
cvs_id_string="$Id: spawn.py,v 1.2 2005/07/20 14:33:12 ferringb Exp $"[5:-2]
